...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        #print('delta_weights_i_h.shape={}, delta_weights_h_o.shape={}'.format(delta_weights_i_h, delta_weights_h_o))
        for X, y in zip(features, targets):
            ...
            delta_weights_h_o += output_error_term * hidden_outputs[:, None] #矩阵相乘总是搞不清左乘还是右乘,试了很多次才试出来
...
# 
# #### 请将你的答案填写在下方
# 模型在前半月表现还好,在后半个月表现不理想,预测值明显偏大.可能是激活函数不合适.
